...
- 动态 Beta-Bernoulli 在 `1146` 个外层开奖期上的平均 Brier score 为 `0.187764272`，相对公平随机概率基线的差值为 `+0.000264272`；逐期开奖差值的普通均值标准误近似区间为 `[+0.000177524, +0.000351021]`，未校正潜在时间相关性，仅作描述。Brier 和 log loss 都是越低越好，因此这里的正差表示动态模型在这段已查看历史上略差。
