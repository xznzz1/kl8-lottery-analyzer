...
| `src.scientific.prospective` | `load_scientific_freeze(path)` | 版本化JSON路径 | `ScientificFreeze` | 在读取开奖前校验九个冻结源码/配置的规范化SHA-256与清单指纹，再校验截止期、参数、seed、奖金情景和快照元信息；漂移要求新策略版本。 |
